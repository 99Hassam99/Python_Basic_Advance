...
# If stock already exist in your list (like info, ril etc) then it
# will append the price to the list. Otherwise it will create new entry
# in your dictionary. For example entering 'tata' and 560 will add
...
def add():
    s=input('enter a stock tikcer to add.')
